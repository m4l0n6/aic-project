                ...
                <g fill="none">
                  ...
                  <defs>
                    <linearGradient id="1752671328339-4791743_star-sparkle_existing_0_t5afbmhh9" x1="12.706" y1="7.902" x2="12.706" y2="18.386" gradientUnits="userSpaceOnUse">
                      <stop offset="2.78%" stopColor="#3B42FF"> </stop>
                      <stop offset="38.88%" stopColor="#BFECDC"> </stop>
                      <stop offset="74.77%" stopColor="#24AFFF"> </stop>
                      <stop offset="97.72%" stopColor="#4FD9C7"> </stop>
                    </linearGradient>
          ...
          <Card className={`${Setting.cardBackgroundGradient} border-border relative overflow-hidden min-h-[380px]`}>
            <div className="right-2 z-0 absolute flex justify-center items-center opacity-100">
              <svg xmlns="http://www.w3.org/2000/svg" width="400" height="300" viewBox="0 0 400 300">
                ...
                <g transform="translate(200,150) rotate(15)" filter="url(#dropShadow)">
                  <ellipse cx="0" cy="20" rx="18" ry="14" 
                          fill="url(#glassGradient)" 
                          stroke="rgba(255,255,255,0.2)" 
                          stroke-width="1"
                          filter="url(#blur)"/>
                  <rect x="16" y="-40" width="3" height="60" 
                        fill="url(#glassGradient)" 
                        stroke="rgba(255,255,255,0.2)" 
                        stroke-width="0.5"
                        filter="url(#blur)"/>
                ...
                <g transform="translate(120,180) rotate(-20)" filter="url(#dropShadow)">
                  <ellipse cx="0" cy="15" rx="12" ry="9" 
                          fill="url(#glassGradient)" 
                          stroke="rgba(255,255,255,0.2)" 
                          stroke-width="1"
                          filter="url(#blur)"/>
                  <rect x="10" y="-25" width="2" height="40" 
                        fill="url(#glassGradient)" 
                        stroke="rgba(255,255,255,0.2)" 
                        stroke-width="0.5"
                        filter="url(#blur)"/>
                  <path d="M12,-25 Q20,-20 18,-10 Q15,-15 12,-15 Z" 
                        fill="url(#glassGradient)" 
                        stroke="rgba(255,255,255,0.2)" 
                        stroke-width="0.5"
                        filter="url(#blur)"/>
                </g>
                <g transform="translate(280,120) rotate(25)" filter="url(#dropShadow)">
                  <ellipse cx="0" cy="15" rx="12" ry="9" 
                          fill="url(#glassGradient)" 
                          stroke="rgba(255,255,255,0.2)" 
                          stroke-width="1"
