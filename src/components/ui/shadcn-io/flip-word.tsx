    ...
    <span ref={localRef} data-slot="flip-words" {...props}>
      ...
      >
        <motion.span
          ...
          className={cn(
            "inline-block relative px-2 text-left will-change-filter will-change-opacity will-change-transform",
            className
          )}
          key={currentWord}
        >
            ...
            >
              {word.split("").map((letter, letterIndex) => (
                <motion.span
                  ...
                  className="inline-block will-change-filter will-change-opacity will-change-transform"
                >
                  {letter}
                </motion.span>
              ))}
